                ...
                <div class="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button id="btnInvitations" class="relative p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition">
                            ...
                            <span id="invitationBadge" class="hidden absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 bg-red-500 text-white text-[10px] rounded-full flex items-center justify-center font-bold">0</span>
                        </button>
                        <!-- Theme -->
                        ${this.themeToggleBtn()}
                        <!-- User -->
